                ...
                <div className="flex-shrink-0">
                  <div className="bg-white rounded-2xl border border-amber-100 p-6 shadow-sm text-center min-w-[200px]">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100">
                      ...
                      <a href="tel:+36305892468" className="text-sm font-bold text-sky-600 hover:text-sky-500 transition-colors">+36 30 589 2468</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-5 group">
                ...
                <div>
                  ...
                  <a href="tel:+36305892468" className="text-xl font-bold text-gray-900 hover:text-sky-600 transition-colors">+36 30 589 2468</a>
                </div>
              </div>
              <div className="flex items-start gap-5 group">

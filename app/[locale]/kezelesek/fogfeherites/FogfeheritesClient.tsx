...
import { ChevronDown, Sparkles, Shield, Clock, Heart, ArrowRight, Plus, Minus, Star, Zap, Award, Smile, Droplets } from 'lucide-react';


function ServiceHero({ imageUrl }: { imageUrl: string }) {
  return <TreatmentHero imageUrl={imageUrl} contentKey="fogfeherites" />;
}
...
export default function FogfeheritesClient({ imageUrl }: { imageUrl: string }) {
  return (

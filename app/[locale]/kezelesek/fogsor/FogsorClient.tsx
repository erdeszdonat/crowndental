...
import { ChevronDown, Shield, Clock, ArrowRight, Plus, Minus, Wrench, Layers, Smile, CheckCircle2 } from 'lucide-react';


function ServiceHero({ imageUrl }: { imageUrl: string }) {
  return <TreatmentHero imageUrl={imageUrl} contentKey="fogsor" />;
}
    ...
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-4xl mx-auto">
          <motion.div animate={{ y: [0, -10, 0] }} transition={{ repeat: Infinity, duration: 4, ease: "easeInOut" }} className="bg-gradient-to-br from-sky-600 to-emerald-600 rounded-[2.5rem] p-10 md:p-16 text-center shadow-2xl shadow-sky-600/20 border border-white/10 relative overflow-hidden">
...
export default function FogsorClient({ imageUrl }: { imageUrl: string }) {
  return (

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/adatkezeles" className="text-gray-400 hover:text-white transition-colors">Adatkezelési Tájékoztató</Link></li>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-6xl">
          {loading ? (
            ...
            <div className="text-center text-gray-500 text-lg py-20">Még nincsenek feltöltve cikkek.</div>
          ) : (

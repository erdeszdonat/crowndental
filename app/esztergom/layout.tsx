...
// A RÉGI FŐOLDAL SEO ADATAI - átmentve az Esztergom aloldalra a Google helyezés megőrzéséhez
export const metadata: Metadata = {
  title: 'Fogászat és Fogtechnikai Labor Esztergomban | Crown Dental',
  description: 'Modern Fogászatot Keres Esztergomban? Fogpótlás, Panoráma röntgen, szájsebészeti, dentálhigiénia és általános fogászat. Várjuk esztergomi fogászati rendelőnkben. 30+ év tapasztalat, saját labor.',
  keywords: [
    'fogászat esztergom',
    'fogorvos esztergom',
  ...
  verification: {
    google: 'YOUR_GOOGLE_VERIFICATION_CODE', // Cseréld ki a saját kódodra
  },
};
